        ...
        <div className="flex flex-col flex-1 h-full min-h-0 ">
          ...
          <div className="flex flex-col items-center justify-center flex-1 min-h-0 py-2 mb-8">
            ...
            <motion.section
              ...
              className="w-full max-w-4xl border border-cyan-600/30
                shadow-[0_0_4px_rgba(34,211,238,0.1)]
                rounded-2xl
                animate-[glow_3s_ease-in-out_infinite] bg-card/40 p-4 2xl:px-5 2xl:py-3 backdrop-blur flex flex-col"
            >
